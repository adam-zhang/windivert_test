				 ...
				 UINT payload_len)
{
	...
	outputDebugString(TEXT("SentDataLength:"), sizeof(block_data) - 1);
	outputDebugString(TEXT("payloadLength:"), payload_len);
	//outputPacket(finish);
...
int __cdecl main(int argc, char **argv)
{
	...
	while (TRUE)
	{
		...
		outputDebugString(TEXT("packet lenght:"), packet_len);
